...
})({"fiw86":[function(require,module,exports) {
"use strict";
...
async function getMostUsedLanguages() {
    ...
    if (response.ok) {
        ...
        for(i in languages){
            for(color in 0, _languageColorsJsonDefault.default)if (color.toLowerCase() == i.toLowerCase()) percentages.push({
                name: i,
...
},{"typed.js":"4hQNd","alpinejs":"69hXP","./data/language_colors.json":"dlAfu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4hQNd":[function(require,module,exports) {
/*!
 * 
...
},{}],"dlAfu":[function(require,module,exports) {
...
},{}]},["fiw86","8ZNvh"], "8ZNvh", "parcelRequire4e47")
